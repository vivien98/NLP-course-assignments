...
def pad_sents(sents, pad_token):
    ...
    length_list = [len(sent) for sent in sents]
    max_len = max(length_list)
    num_paddings = [(max_len-sent_length) for sent_length in length_list]
    for i in range(len(num_paddings)):
        sents_padded[i].extend([pad_token]*num_paddings[i])
    ### END YOUR CODE
